...
function FastClick(t, e) {
  ...
  if (e = e || {}, this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null,
    ...
    for (var s = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], i = this, r = 0, a = s.length; a > r; r++) i[s[r]] = n(i[s[r]], i);
    deviceIsAndroid && (t.addEventListener("mouseover", this.onMouse, !0), t.addEventListener("mousedown", this.onMouse, !0),
      ...
      Event.prototype.stopImmediatePropagation || (t.removeEventListener = function(e, n, o) {
        ...
        "click" === e ? s.call(t, e, n.hijacked || n, o) : s.call(t, e, n, o);
      }, t.addEventListener = function(e, n, o) {
        var s = Node.prototype.addEventListener;
        "click" === e ? s.call(t, e, n.hijacked || (n.hijacked = function(t) {
...
! function(t) {
  ...
  e._document = document, e._navigator = navigator, e.defaults = {
    ...
    return s = e._getExtendedOptions(s), s.expires = e._getExpiresDate(o === t ? -1 : s.expires),
      e._document.cookie = e._generateCookieString(n, o, s), e;
    ...
    for (var o = {}, s = n ? n.split("; ") : [], i = 0; i < s.length; i++) {
      var r = e._getKeyValuePairFromCookieString(s[i]);
...
FastClick.prototype.needsClick = function(t) {
  ...
  "use strict";
  var e, n, o, s, i, r = this.targetElement;
  if (!this.trackingClick) return !0;
  if (t.timeStamp - this.lastClickTime < this.tapDelay) return this.cancelNextClick = !0, !0;
  if (this.cancelNextClick = !1, this.lastClickTime = t.timeStamp, n = this.trackingClickStart,
    this.trackingClick = !1, this.trackingClickStart = 0, deviceIsIOSWithBadTarget && (i = t.changedTouches[0],
      r = document.elementFromPoint(i.pageX - window.pageXOffset, i.pageY - window.pageYOffset) || r,
    ...
    t.preventDefault()), !1);
  return deviceIsIOS && !deviceIsIOS4 && (s = r.fastClickScrollParent, s && s.fastClickLastScrollTop !== s.scrollTop) ? !0 : (this.needsClick(r) || (t.preventDefault(),
...
var Prism = function() {
  var t = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
    e = self.Prism = {
      util: {
        ...
        clone: function(t) {
          ...
          switch (n) {
            case "Object":
              var o = {};
              for (var s in t) t.hasOwnProperty(s) && (o[s] = e.util.clone(t[s]));
              return o;
      ...
      languages: {
        ...
        DFS: function(t, n, o) {
          for (var s in t) t.hasOwnProperty(s) && (n.call(t, s, t[s], o || s), "Object" === e.util.type(t[s]) ? e.languages.DFS(t[s], n) : "Array" === e.util.type(t[s]) && e.languages.DFS(t[s], n, s));
        }
      },
      highlightAll: function(t, n) {
        for (var o, s = document.querySelectorAll('code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'), i = 0; o = s[i++];) e.highlightElement(o, t === !0, n);
      },
      highlightElement: function(n, o, s) {
        for (var i, r, a = n; a && !t.test(a.className);) a = a.parentNode;
        if (a && (i = (a.className.match(t) || [, ""])[1], r = e.languages[i]), r) {
          n.className = n.className.replace(t, "").replace(/\s+/g, " ") + " language-" + i,
            a = n.parentNode, /pre/i.test(a.nodeName) && (a.className = a.className.replace(t, "").replace(/\s+/g, " ") + " language-" + i);
          var c = n.textContent;
          if (c) {
            var l = {
              element: n,
            ...
            e.hooks.run("before-highlight", l), l.highlightedCode = e.highlight(l.code, l.grammar, l.language),
              e.hooks.run("before-insert", l), l.element.innerHTML = l.highlightedCode, s && s.call(n),
              e.hooks.run("after-highlight", l);
          }
        }
      },
      highlight: function(t, o, s) {
        var i = e.tokenize(t, o);
        return n.stringify(e.util.encode(i), s);
      },
                ...
                if (!(g instanceof o)) {
                  ...
                  if (y) {
                    ...
                    var m = y.index - 1 + h,
                      ...
                      k = [f, 1];
                    b && k.push(b);
                    var C = new o(r, p ? e.tokenize(y, p) : y, d);
                    k.push(C), _ && k.push(_), Array.prototype.splice.apply(s, k);
                  }
                }
              }
            }
  ...
  return n.stringify = function(t, o, s) {
    ...
    var i = {
      type: t.type,
      content: n.stringify(t.content, o, s),
      tag: "span",
    ...
    e.hooks.run("wrap", i);
    var a = "";
    for (var c in i.attributes) a += c + '="' + (i.attributes[c] || "") + '"';
...
Prism.languages.markup = {
  ...
  function(t, e) {
    ...
    function u() {
      I = "?sentry_version=4&sentry_client=raven-js/" + F.VERSION + "&sentry_key=" + $;
    }

    function h(t, e) {
      var o = [];
      t.stack && t.stack.length && p(t.stack, function(t, e) {
        var n = d(e);
        n && o.push(n);
      }), n("handle", {
        stackInfo: t,
    ...
    function d(t) {
      if (t.url) {
        ...
        return n.in_app = !(!B.includePaths.test(n.filename) || /(Raven|TraceKit)\./.test(n["function"]) || /raven\.(min\.)?js$/.test(n.filename)),
          n;
      }
    }

    function f(t) {
      if (t.context && B.fetchContext) {
        for (var e = t.context, n = ~~(e.length / 2), o = e.length, s = !1; o--;)
          if (e[o].length > 300) {
            s = !0;
            break;
          }
        if (s) {
          if (i(t.column)) return;
          return [
    ...
    function g(t, e, n, o, s, i) {
      var r, a;
      e += "", ("Error" !== t || e) && (B.ignoreErrors.test(e) || (s && s.length ? (n = s[0].filename || n,
        s.reverse(), r = {
          frames: s
        }) : n && (r = {
        frames: [{
      ...
      }), e = m(e, 100), B.ignoreUrls && B.ignoreUrls.test(n) || (!B.whitelistUrls || B.whitelistUrls.test(n)) && (a = o ? e + " at " + o : e,
        w(y({
          exception: {
            type: t,
            value: e
    ...
    function w(t) {
      _() && (t = y({
          ...
          platform: "javascript",
          request: v()
        }, t), t.tags = y(B.tags, t.tags), t.extra = y(B.extra, t.extra), c(t.tags) && delete t.tags,
        c(t.extra) && delete t.extra, R && (t.user = R), r(B.dataCallback) && (t = B.dataCallback(t)), (!r(B.shouldSendCallback) || B.shouldSendCallback(t)) && (L = t.event_id || (t.event_id = C()),
          b(t)));
    }

    function b(t) {
      var e = new Image(),
        o = N + I + "&sentry_data=" + encodeURIComponent(JSON.stringify(t));
      e.onload = function() {
        n("success", {
          data: t,
          src: o
    ...
    function _() {
      return O ? N ? !0 : (S("error", "Error: Raven has not been configured."), !1) : !1;
    }

    function k(t) {
      for (var e, n = [], o = 0, s = t.length; s > o; o++) e = t[o], a(e) ? n.push(e.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1")) : e && e.source && n.push(e.source);
    ...
    x.wrap = function(t) {
      ...
      function r(t, e, n, o, s) {
        var r = null;
        if (m) x.computeStackTrace.augmentStackTraceWithInitialElement(m, e, n, t), p();
        else if (s) r = x.computeStackTrace(s),
          i(r, !0);
        else {
          var a = {
            url: e,
      ...
      function p() {
        var t = m,
          e = g;
        g = null, m = null, y = null, i.apply(null, [t, !1].concat(e));
      }
      ...
      function u(e, n) {
        ...
        var s = x.computeStackTrace(e);
        if (m = s, y = e, g = o, t.setTimeout(function() {
            y === e && p();
          }, s.incomplete ? 2e3 : 0), n !== !1) throw e;
      }
      var h, d, f = [],
        g = null,
        y = null,
        m = null;
      return u.subscribe = n, u.unsubscribe = o, u.uninstall = s, u;
      ...
      function s(t, e) {
        ...
        e -= 1;
        for (var p = c; l > p; ++p) i(o[p]) || s.push(o[p]);
      ...
      function p(t, e) {
        for (var o, s, i = 0, r = e.length; r > i; ++i)
          if ((o = n(e[i])).length && (o = o.join("\n"),
              s = t.exec(o))) return {
            url: e[i],
            line: o.substring(0, s.index).split("\n").length,
            column: s.index - o.lastIndexOf("\n", s.index) - 1
          };
        return null;
      }
      ...
      function u(t, e, o) {
        ...
        return o -= 1, i && i.length > o && (s = a.exec(i[o])) ? s.index : null;
      }

      function h(e) {
        for (var n, o, s, i, a = [t.location.href], l = document.getElementsByTagName("script"), u = "" + e, h = /^function(?:\s+([\w$]+))?\s*\(([\w\s,]*)\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/, d = /^function on([\w$]+)\s*\(event\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/, f = 0; f < l.length; ++f) {
          var g = l[f];
          g.src && a.push(g.src);
        }
        if (s = h.exec(u)) {
          var y = s[1] ? "\\s+" + s[1] : "",
            m = s[2].split(",").join("\\s*,\\s*");
          n = r(s[3]).replace(/;$/, ";?"), o = new RegExp("function" + y + "\\s*\\(\\s*" + m + "\\s*\\)\\s*{\\s*" + n + "\\s*}");
        } else o = new RegExp(r(u).replace(/\s+/g, "\\s+"));
        if (i = p(o, a)) return i;
        if (s = d.exec(u)) {
          var v = s[1];
          if (n = c(s[2]), o = new RegExp("on" + v + "=[\\'\"]\\s*" + n + "\\s*[\\'\"]", "i"),
            i = p(o, a[0])) return i;
          if (o = new RegExp(n), i = p(o, a)) return i;
        }
        return null;
      }
      ...
      function d(t) {
        ...
        for (var e, n, r = /^\s*at (?:((?:\[object object\])?\S+(?: \[as \S+\])?) )?\(?((?:file|https?|chrome-extension):.*?):(\d+)(?::(\d+))?\)?\s*$/i, a = /^\s*(\S*)(?:\((.*?)\))?@((?:file|https?|chrome).*?):(\d+)(?::(\d+))?\s*$/i, c = t.stack.split("\n"), l = [], p = /^(.*) is undefined$/.exec(t.message), h = 0, d = c.length; d > h; ++h) {
          ...
          }!n.func && n.line && (n.func = o(n.url, n.line)), n.line && (n.context = s(n.url, n.line)),
            l.push(n);
        }
        return l.length ? (l[0].line && !l[0].column && p ? l[0].column = u(p[1], l[0].url, l[0].line) : l[0].column || i(t.columnNumber) || (l[0].column = t.columnNumber + 1), {
          name: t.name,
          message: t.message,
          url: document.location.href,
          stack: l
      ...
      function f(t) {
        for (var e, n = t.stacktrace, i = / line (\d+), column (\d+) in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\) in (.*):\s*$/i, r = n.split("\n"), a = [], c = 0, l = r.length; l > c; c += 2)
          if (e = i.exec(r[c])) {
            var p = {
              line: +e[1],
              column: +e[2],
            ...
            if (!p.func && p.line && (p.func = o(p.url, p.line)), p.line) try {
              p.context = s(p.url, p.line);
            } catch (u) {}
            p.context || (p.context = [r[c + 1]]), a.push(p);
          }
        return a.length ? {
          name: t.name,
          message: t.message,
      ...
      function g(e) {
        ...
        var r, a, u, h, d = /^\s*Line (\d+) of linked script ((?:file|https?)\S+)(?:: in function (\S+))?\s*$/i,
        ...
        for (a = 2, u = i.length; u > a; a += 2) {
          ...
          } else if (r = g.exec(i[a])) {
            var C = t.location.href.replace(/#.*$/, ""),
              S = r[1],
              E = new RegExp(c(i[a + 1]));
            h = p(E, [C]), w = {
              url: C,
              line: h ? h.line : S,
              func: ""
          ...
          if (w) {
            ...
            var x = s(w.url, w.line),
              T = x ? x[Math.floor(x.length / 2)] : null;
            w.context = x && T.replace(/^\s*/, "") === i[a + 1].replace(/^\s*/, "") ? x : [i[a + 1]],
              y.push(w);
          }
        }
        return y.length ? {
      ...
      function y(t, e, n, i) {
        ...
        if (r.url && r.line) {
          t.incomplete = !1, r.func || (r.func = o(r.url, r.line)), r.context || (r.context = s(r.url, r.line));
          var a = / '([^']+)' /.exec(i);
          if (a && (r.column = u(a[1], r.url, r.line)), t.stack.length > 0 && t.stack[0].url === r.url) {
      ...
      function m(t, e) {
        for (var n, s, i, r = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, a = [], c = {}, l = !1, p = m.caller; p && !l; p = p.caller)
          if (p !== v && p !== x.report) {
            if (s = {
                url: null,
                func: P,
                line: null,
                column: null
              }, p.name ? s.func = p.name : (n = r.exec(p.toString())) && (s.func = n[1]), i = h(p)) {
              s.url = i.url, s.line = i.line, s.func === P && (s.func = o(s.url, s.line));
              var d = / '([^']+)' /.exec(t.message || t.description);
              d && (s.column = u(d[1], i.url, i.line));
            }
            c["" + p] ? l = !0 : c["" + p] = !0, a.push(s);
          }
        e && a.splice(0, e);
        var f = {
          name: t.name,
      ...
      var b = !1,
        _ = {};
      return v.augmentStackTraceWithInitialElement = y, v.guessFunctionName = o, v.gatherContext = s,
        v.ofCaller = w, v;
    }();
    var D, L, N, R, $, A, I, M = t.Raven,
      O = !(!t.JSON || !t.JSON.stringify),
      B = {
        logger: "javascript",
        ignoreErrors: [],
        ignoreUrls: [],
      ...
      F = {
        ...
        config: function(t, e) {
          ...
          return e && p(e, function(t, e) {
              B[t] = e;
            }), B.ignoreErrors.push("Script error."), B.ignoreErrors.push("Script error"), B.ignoreErrors.push("Javascript error: Script error on line 0"),
            B.ignoreErrors.push("Javascript error: Script error. on line 0"), B.ignoreErrors = k(B.ignoreErrors),
            B.ignoreUrls = B.ignoreUrls.length ? k(B.ignoreUrls) : !1, B.whitelistUrls = B.whitelistUrls.length ? k(B.whitelistUrls) : !1,
            B.includePaths = k(B.includePaths), $ = n.user, A = n.path.substr(o + 1), N = "//" + n.host + (n.port ? ":" + n.port : "") + "/" + i + "api/" + A + "/store/",
            n.protocol && (N = n.protocol + ":" + N), B.fetchContext && (x.remoteFetching = !0),
            B.linesOfContext && (x.linesOfContext = B.linesOfContext), x.collectWindowErrors = !!B.collectWindowErrors,
            u(), F;
        },
        install: function() {
        ...
        wrap: function(t, n) {
          function o() {
            for (var e = [], o = arguments.length, s = !t || t && t.deep !== !1; o--;) e[o] = s ? F.wrap(t, arguments[o]) : arguments[o];
            try {
              return n.apply(this, e);
            } catch (i) {
              throw F.captureException(i, t), i;
            }
          }
          if (i(n) && !r(t)) return t;
          if (r(t) && (n = t, t = e), !r(n)) return n;
          if (n.__raven__) return n;
          for (var s in n) l(n, s) && (o[s] = n[s]);
  ...
  function() {}.call(this),
  function() {
    var t, e, n, o, s, i, r, a, c, l, p, u, h, d;
    t = {
      json: "application/json",
      html: "text/html"
    }, this.ajax = function(t) {
      var i;
      return o(t), h(t), i = new XMLHttpRequest(), i.open(t.type, t.url, t.async), n(i, t),
        s(i, t), i.send(t.data), t.async ? {
          abort: e.bind(void 0, i)
        } : u(i, t);
    }, ajax.defaults = {
      async: !0,
      dataType: "json",
      ...
      n.headers || (n.headers = {}), n.contentType && (n.headers["Content-Type"] = n.contentType), !n.headers["Content-Type"] && n.data && "GET" !== n.type && (n.headers["Content-Type"] = "application/x-www-form-urlencoded"),
        n.dataType && (n.headers.Accept = t[n.dataType] || n.dataType), i(n.url) && (n.headers["X-Requested-With"] = "XMLHttpRequest"),
        r = n.headers;
      for (o in r) s = r[o], e.setRequestHeader(o, s);
    }, r = function(t, e) {
      var n, o;
      200 <= (o = t.status) && 300 > o ? null != (n = u(t, e)) ? c(n, t, e) : a("invalid", t, e) : a("error", t, e);
    }, c = function(t, e, n) {
      var o;
  ...
  function() {
    ...
    this.Events = {
      on: function(t, e) {
        var n, o, s, i, r;
        if (t.indexOf(" ") >= 0)
          for (r = t.split(" "), s = 0, i = r.length; i > s; s++) n = r[s],
            this.on(n, e);
      ...
      off: function(t, e) {
        var n, o, s, i, r, a, c;
        if (t.indexOf(" ") >= 0)
          for (a = t.split(" "), i = 0, r = a.length; r > i; i++) s = a[i],
            this.off(s, e);
      ...
      trigger: function() {
        var e, n, o, s, i, r, a, c;
        if (s = arguments[0], e = 2 <= arguments.length ? t.call(arguments, 1) : [], o = null != (a = this._callbacks) ? a[s] : void 0)
          for (c = o.slice(0),
            i = 0, r = c.length; r > i; i++) n = c[i], "function" == typeof n && n.apply(null, e);
        return "all" !== s && this.trigger.apply(this, ["all", s].concat(t.call(e))),
          this;
      },
      removeEvent: function(t) {
        var e, n, o, s;
        if (null != this._callbacks)
          for (s = t.split(" "), n = 0, o = s.length; o > n; n++) e = s[n],
   ...
   */
  function() {
    var t, e, n, o, s, i, r, a, c, l, p;
    l = !1, s = null, n = [], this.page = function(t, o) {
      var s;
      "function" == typeof t ? page("*", t) : "function" == typeof o ? (s = new e(t), n.push(s.middleware(o))) : "string" == typeof t ? page.show(t, o) : page.start(t);
      ...
      var o;
      if (e !== (null != s ? s.path : void 0)) return o = new t(e, n), s = o.state, page.dispatch(o),
        o.pushState(), p(), o;
    }, page.replace = function(e, n, o, i) {
      var r;
      return r = new t(e, n || s), r.init = i, s = r.state, o || page.dispatch(r), r.replaceState(),
        i || o || p(), r;
      ...
      return t.prototype.middleware = function(t) {
        return function(e) {
          return function(n, o) {
            var s;
            e.match(n.pathname, s = []) ? (n.params = s, t(n, o)) : o();
          };
        }(this);
      }, t.prototype.match = function(t, e) {
        var n, o, s, i, r, a, c;
        if (s = this.regexp.exec(t)) {
          for (c = s.slice(1), n = r = 0, a = c.length; a > r; n = ++r) i = c[n], "string" == typeof i && (i = decodeURIComponent(i)), (o = this.keys[n]) ? e[o.name] = i : e.push(i);
          return !0;
        }
      }, t;
    }(), c = function(t, e) {
      return t instanceof RegExp ? t : (t instanceof Array && (t = "(" + t.join("|") + ")"),
        t = t.replace(/\/\(/g, "(?:/").replace(/(\/)?(\.)?:(\w+)(?:(\(.*?\)))?(\?)?/g, function(t, n, o, s, i, r) {
          var a;
          return null == n && (n = ""), null == o && (o = ""), e.push({
              name: s,
              optional: !!r
            }), a = r ? "" : n, a += "(?:", r && (a += n), a += o, a += i || (o ? "([^/.]+?)" : "([^/]+?)"),
            a += ")", r && (a += r), a;
      ...
      if (!(1 !== t.which || t.metaKey || t.ctrlKey || t.shiftKey || t.defaultPrevented)) {
        ...
        e && !e.target && i(e.href) && (t.preventDefault(), page.show(e.pathname + e.search + e.hash));
      }
    }, i = function(t) {
  ...
  function() {
    ...
    this.$ = function(t, e) {
      ...
      if (null == o && (o = !1), e.indexOf(" ") >= 0)
        for (a = e.split(" "), i = 0, r = a.length; r > i; i++) s = a[i],
          $.on(t, s, n);
      ...
      var s;
      null == n && (n = !0), null == o && (o = !0), s = document.createEvent("Event"),
        s.initEvent(e, n, o), t.dispatchEvent(s);
    }, $.click = function(t) {
      var e;
      ...
      if (n = document.createDocumentFragment(), $.isCollection(t))
        for (i = $.makeArray(t),
          o = 0, s = i.length; s > o; o++) e = i[o], n.appendChild(e);
      else n.innerHTML = t;
      return n;
    }, $.append = function(t, e) {
      ...
      ("string" == typeof e || $.isCollection(e)) && (e = s(e)), t.parentElement.insertBefore(e, t);
    }, $.after = function(t, e) {
      ("string" == typeof e || $.isCollection(e)) && (e = s(e)), t.nextSibling ? t.parentElement.insertBefore(e, t.nextSibling) : t.parentElement.appendChild(e);
    }, $.remove = function(t) {
      var e, n, o, s;
      if ($.isCollection(t))
        for (s = $.makeArray(t), n = 0, o = s.length; o > n; n++) e = s[n],
      ...
      if (null == n && (n = "center"), null == o && (o = {}), t && (null == e && (e = $.scrollParent(t)),
          e && (i = e.clientHeight, e.scrollHeight > i))) switch (a = $.offset(t, e).top,
        n) {
        case "top":
        ...
        case "center":
          e.scrollTop = a - Math.round(i / 2 - t.offsetHeight / 2);
          break;

        case "continuous":
          r = e.scrollTop, s = t.offsetHeight, a <= r + s * (o.topGap || 1) ? e.scrollTop = a - s * (o.topGap || 1) : a >= r + i - s * ((o.bottomGap || 1) + 1) && (e.scrollTop = a - i + s * ((o.bottomGap || 1) + 1));
      }
    }, $.scrollToWithImageLock = function() {
      var t, e, n, o, s, r, a;
      if (e = arguments[0], o = arguments[1], t = 3 <= arguments.length ? i.call(arguments, 2) : [],
        null == o && (o = $.scrollParent(e)), o)
        for ($.scrollTo.apply($, [e, o].concat(i.call(t))),
          a = o.getElementsByTagName("img"), s = 0, r = a.length; r > s; s++) n = a[s], n.complete || ! function() {
          var s, r, a;
          return s = function(n) {
            return clearTimeout(r), a(n.target), $.scrollTo.apply($, [e, o].concat(i.call(t)));
          }, a = function(t) {
            return $.off(t, "load", s);
          }, $.on(n, "load", s), r = setTimeout(a.bind(null, n), 3e3);
        }();
      ...
      var t, e, n, o, s, r, a;
      for (o = arguments[0], n = 2 <= arguments.length ? i.call(arguments, 1) : [], r = 0,
        a = n.length; a > r; r++)
        if (e = n[r])
  ...
  function() {
    ...
    this.app = {
      ...
      bootAll: function() {
        var t, e, n, o, s;
        for (e = this.settings.getDocs(), s = this.DOCS, n = 0, o = s.length; o > n; n++) t = s[n], (e.indexOf(t.slug) >= 0 ? this.docs : this.disabledDocs).add(t);
      ...
      start: function() {
        var t, e, n, o, s, i, r, a;
        for (r = this.docs.all(), n = 0, s = r.length; s > n; n++) {
          for (t = r[n], this.entries.add(t.toEntry()), a = t.types.all(), o = 0, i = a.length; i > o; o++) e = a[o],
            this.entries.add(e.toEntry());
          this.entries.add(t.entries.all());
        }
        this.trigger("ready"), this.router.start(), this.hideLoading(), this.doc || this.welcomeBack(),
      ...
      reset: function() {
        var t;
        this.store.clear(), this.settings.reset(), null != (t = this.appCache) && t.update(),
          window.location = "/";
      },
      ...
      isSupportedBrowser: function() {
        ...
        try {
          ...
          for (o in n)
            if (s = n[o], !s) return Raven.captureMessage("unsupported/" + o), !1;
          return !0;
        } catch (i) {
          return e = i, Raven.captureMessage("unsupported/exception", {
            extra: {
              error: e
            }
          }), !1;
  ...
  function() {
    app.Router = function() {
      function t() {
        var t, e, n, o, s, i;
        for (s = this.constructor.routes, n = 0, o = s.length; o > n; n++) i = s[n], e = i[0],
          t = i[1], page(e, this[t].bind(this));
        this.setInitialPath();
      }
  ...
  function() {
    ...
    function e() {
      if (g = 100 - (v - f), a > 0) {
        if (m.charAt(a - 1) === s) g += a - 1;
        else {
          if (1 === f) return;
          for (r = a - 2; r >= 0 && m.charAt(r) !== s;) r--;
          g -= a - r + (v - f - a);
        }
        for (y = 0, r = a - 2; r >= 0;) m.charAt(r) === s && y++, r--;
        g -= y;
      }
      for (y = 0, r = v - f - a - 1; r >= 0;) m.charAt(a + f + r) === s && y++, r--;
      return g -= 5 * y, Math.max(1, g);
    }

    function n() {
      return f >= v || m.indexOf(d) >= 0 || !(l = i.exec(m)) ? void 0 : (p = l.index, u = l[0].length,
        g = o(), (l = i.exec(m.slice(r = m.lastIndexOf(s) + 1))) ? (p = r + l.index, u = l[0].length,
          Math.max(g, o())) : g);
    }

    function o() {
      return 0 === p || m.charAt(p - 1) === s ? Math.max(66, 100 - u) : p + u === v ? Math.max(33, 67 - u) : Math.max(1, 34 - u);
    }
    var s, i, r, a, c, l, p, u, h, d, f, g, y, m, v, w = function(t, e) {
        return function() {
          return t.apply(e, arguments);
        };
      },
    ...
    s = ".", d = f = m = v = h = i = a = c = l = p = u = g = y = r = null, app.Searcher = function() {
      ...
      return $.extend(e.prototype, Events), o = 2e4, s = {
        ...
        f >= this.options.fuzzy_min_length ? (i = this.queryToFuzzyRegexp(d), this.matchers.push(n)) : i = null;
        ...
        var e, n, o, s;
        for (n = t.split(""), r = o = 0, s = n.length; s > o; r = ++o) e = n[r], n[r] = $.escapeRegexp(e);
  ...
  function() {
    app.Collection = function() {
      ...
      return t.prototype.model = function() {
        ...
        else t instanceof app.Collection ? (s = this.models).push.apply(s, t.all()) : this.models.push(new(this.model())(t));
        ...
        var e, n, o, s;
        for (s = this.models, n = 0, o = s.length; o > n; n++) e = s[n], t(e);
      }, t.prototype.all = function() {
        return this.models;
      }, t.prototype.findBy = function(t, e) {
        var n, o, s, i;
        for (i = this.models, o = 0, s = i.length; s > o; o++)
          if (n = i[o], n[t] === e) return n;
      }, t.prototype.findAllBy = function(t, e) {
        var n, o, s, i, r;
        for (i = this.models, r = [], o = 0, s = i.length; s > o; o++) n = i[o], n[t] === e && r.push(n);
        return r;
      }, t;
    }();
  }.call(this),
  function() {
    ...
    app.collections.Docs = function(t) {
      ...
      }, s = 3, o.prototype.load = function(t, e, o) {
        var i, r, a, c;
        for (r = 0, a = function(e) {
            return function() {
              r < e.models.length ? e.models[r].load(a, i, o) : r === e.models.length + s - 1 && t(),
                r++;
            };
          }(this), i = function() {
            var t;
    ...
    app.models.Doc = function(t) {
      ...
      return e(n, t), n.prototype.reset = function(t) {
        ...
        return null == n && (n = {}), n.readCache && this._loadFromCache(t) ? void 0 : (o = function(e) {
          return function(o) {
            return e.reset(o), t(), n.writeCache ? e._setCache(o) : void 0;
          };
        }(this), ajax({
          url: this.indexUrl(),
          success: o,
  ...
  function() {
    ...
    app.models.Entry = function(t) {
      ...
      var o, s, i, r;
      return e(n, t), r = /\:?\ |#|::|->/g, i = /\(.*?\)$/, s = /\ event$/, o = /\.+/g,
        n.prototype.searchValue = function() {
          return this.name.toLowerCase().replace("...", " ").replace(s, "").replace(r, ".").replace(o, ".").replace(i, "").trim();
    ...
    app.View = function() {
      ...
      return $.extend(e.prototype, Events), e.prototype.setupElement = function() {
        ...
        if (this.constructor.shortcuts) {
          s = this.constructor.shortcuts;
          for (e in s) t = s[e], app.shortcuts.on(e, this[t]);
        }
        ...
        if (this.constructor.shortcuts) {
          s = this.constructor.shortcuts;
          for (e in s) t = s[e], app.shortcuts.off(e, this[t]);
        }
  ...
  function() {
    var t = function(t, e) {
      ...
      n = function(t, n) {
        ...
        for (var s in n) e.call(n, s) && (t[s] = n[s]);
    ...
    app.views.Content = function(e) {
      ...
      return n(o, e), o.el = "._content", o.loadingClass = "_content-loading", o.events = {
        ...
        this.scrollEl = app.isMobile() ? document.body : this.el, this.scrollMap = {}, this.scrollStack = [],
          ...
          this.typePage = new app.views.TypePage(), this.entryPage = new app.views.EntryPage(),
        ...
        var e;
        t !== this.view && (null != (e = this.view) && e.deactivate(), this.html(this.view = t),
          this.view.activate());
  ...
  function() {
    ...
    app.views.EntryPage = function(e) {
      ...
      return n(o, e), o.className = "_page", o.loadingClass = "_page-loading", o.events = {
        click: "onClick"
      }, o.routes = {
        before: "beforeRoute"
      }, o.prototype.init = function() {
        ...
        null == t && (t = ""), this.empty(), this.subview = new(this.subViewClass())(this.el, this.entry),
  ...
  function() {
    ...
    app.views.Path = function(e) {
      ...
      return n(s, e), s.className = "_path", s.events = {
        click: "onClick"
      }, s.routes = {
        after: "afterRoute"
      ...
      }, s.prototype.afterRoute = function(t, e) {
  ...
  function() {
    ...
    app.views.PaginatedList = function(e) {
      function o(e) {
        var n, s;
        this.data = e, this.onClick = t(this.onClick, this), null == (n = (s = this.constructor).events || (s.events = {})).click && (n.click = "onClick"),
          o.__super__.constructor.apply(this, arguments);
      }
      var s;
      return n(o, e), s = app.config.max_results, o.prototype.renderPaginated = function() {
        ...
        var e, n, o;
        if (e = this.data.indexOf(t), e >= s)
          for (n = 0, o = Math.floor(e / s); o >= 0 ? o > n : n > o; o >= 0 ? n++ : n--) this.paginateNext();
      }, o.prototype.hideTopPage = function() {
        var t, e;
        for (t = this.page <= 2 ? s : s + 1, e = 0; t >= 0 ? t > e : e > t; t >= 0 ? e++ : e--) this.remove(this.el.firstChild);
        this.prepend(this.renderPrevLink(this.page));
      }, o.prototype.hideBottomPage = function() {
        var t, e;
        for (t = this.page === this.totalPages() ? this.data.length % s || s : s + 1, e = 0; t >= 0 ? t > e : e > t; t >= 0 ? e++ : e--) this.remove(this.el.lastChild);
  ...
  function() {
    ...
    app.views.News = function(t) {
      ...
      return e(n, t), n.className += " _notif-news", n.defautOptions = {
        ...
        for (s = app.news, i = [], n = 0, o = s.length; o > n && (t = s[n], !(new Date(t[0]).getTime() <= e)); n++) i.push(t);
        return i;
  ...
  function() {
    ...
    app.views.BasePage = function(t) {
      ...
      return e(n, t), n.prototype.render = function(t) {
        ...
        var n, o, s;
        if ($.isCollection(t))
          for (o = 0, s = t.length; s > o; o++) n = t[o], this.highlightCode(n, e);
  ...
  function() {
    ...
    app.views.AngularPage = function(t) {
      ...
      return e(n, t), n.prototype.afterRender = function() {
        var t, e, n, o, s;
        for (s = this.findAllByTag("pre"), n = 0, o = s.length; o > n; n++) t = s[n], e = t.classList.contains("lang-html") || "<" === t.textContent[0] ? "markup" : t.classList.contains("lang-css") ? "css" : "javascript",
  ...
  function() {
    ...
    app.views.EmberPage = function(t) {
      ...
      return e(n, t), n.prototype.afterRender = function() {
        var t, e, n, o, s;
        for (s = this.findAllByTag("pre"), n = 0, o = s.length; o > n; n++) t = s[n], e = t.classList.contains("javascript") ? "javascript" : t.classList.contains("html") ? "markup" : void 0,
  ...
  function() {
    ...
    app.views.JavascriptPage = function(t) {
        ...
        return e(n, t), n.prototype.afterRender = function() {
          var t, e, n, o, s;
          for (s = this.findAllByTag("pre"), n = 0, o = s.length; o > n; n++) t = s[n], e = t.textContent.match(/^\s*</) ? "markup" : "javascript",
  ...
  function() {
    ...
    app.views.JqueryPage = function(e) {
      ...
      return n(o, e), o.demoClassName = "_jquery-demo", o.prototype.afterRender = function() {
        var t, e, n, o, s, i, r, a, c;
        for (a = this.findAllByTag("iframe"), o = 0, i = a.length; i > o; o++) e = a[o],
          e.style.display = "none", $.on(e, "load", this.onIframeLoaded);
        for (this.runExamples(), c = this.findAllByClass("syntaxhighlighter"), s = 0, r = c.length; r > s; s++) t = c[s],
  ...
  function() {
    ...
    app.views.KnockoutPage = function(t) {
      ...
      return e(n, t), n.prototype.afterRender = function() {
        var t, e, n, o, s;
        for (s = this.findAll("pre"), n = 0, o = s.length; o > n; n++) t = s[n], e = t.innerHTML.indexOf('data-bind="') > 0 ? "markup" : "javascript",
          this.highlightCode(t, e);
      }, n;
    }(app.views.BasePage);
  }.call(this),
    ...
    app.views.MaxcdnPage = function(t) {
      ...
      return e(n, t), n.events = {
        ...
        if ("tab" === (n = t.target).getAttribute("data-toggle")) {
          for ($.stopEvent(t), o = n.parentNode.parentNode, i = o.nextElementSibling, e = n.parentNode,
            s = 1; e = e.previousElementSibling;) s++;
          return $(".active", o).classList.remove("active"), $(".active", i).classList.remove("active"),
            n.parentNode.classList.add("active"), $(".tab-pane:nth-child(" + s + ")", i).classList.add("active");
        }
      }, n;
    }(app.views.BasePage);
  }.call(this),
  function() {
    ...
    app.views.MdnPage = function(t) {
      ...
      return e(n, t), n.className = "_mdn", o = /brush: ?(\w+)/, n.prototype.afterRender = function() {
        var t, e, n, s, i;
        for (i = this.findAll('pre[class^="brush"]'), n = 0, s = i.length; s > n; n++) t = i[n],
  ...
  function() {
    ...
    app.views.Search = function(e) {
      ...
      var s;
      return n(o, e), s = app.config.search_param, o.el = "._search", o.activeClass = "_search-active",
        o.elements = {
          input: "._search-input",
          ...
          var t;
          try {
            return null != (t = new RegExp("#" + s + "=(.*)").exec($.urlDecode(location.hash))) ? t[1] : void 0;
          } catch (e) {}
        }, o;
    }(app.View);
  }.call(this),
  function() {
    ...
    app.views.SearchScope = function(e) {
      ...
      var s;
      return n(o, e), s = app.config.search_param, o.elements = {
        input: "._search-input",
        tag: "._search-tag"
      }, o.events = {
        keydown: "onKeydown"
        ...
        var t, e;
        return (e = this.getHashValue()) ? (t = $.urlDecode(location.hash).replace("#" + s + "=" + e + " ", "#" + s + "="),
  ...
  function() {
    ...
    app.views.DocPicker = function(e) {
      ...
      return n(o, e), o.className = "_list", o.elements = {
        ...
        this.saving || (this.saving = !0, app.settings.setDocs(this.getSelectedDocs()),
          this.saveLink.textContent = app.appCache ? "Downloading\u2026" : "Saving\u2026",
          app.reload());
      }, o.prototype.getSelectedDocs = function() {
        var t, e, n, o, s;
        for (o = this.findAllByTag("input"), s = [], e = 0, n = o.length; n > e; e++) t = o[e], (null != t ? t.checked : void 0) && s.push(t.name);
        return s;
      }, o.prototype.onClick = function(t) {
  ...
  function() {
    ...
    app.views.SidebarHover = function(n) {
      ...
      return o(s, n), s.itemClass = "_list-hover", s.events = {
        focus: "onFocus",
        blur: "onBlur",
      ...
      }, s.prototype.makeClone = function(t) {
        var e;
        return e = t.cloneNode(), e.textContent = t.textContent, e.classList.add("clone"),
          e;
      }, s.prototype.isTarget = function(t) {
        return t.classList.contains(this.constructor.itemClass);
      }, s.prototype.isSelected = function(t) {
        return t.classList.contains("active");
      }, s.prototype.isTruncated = function(t) {
  ...
  function() {
    ...
    app.templates.render = function() {
      ...
      if (n = arguments[0], r = arguments[1], e = 3 <= arguments.length ? t.call(arguments, 2) : [],
        s = app.templates[n], Array.isArray(r)) {
        for (o = "", a = 0, c = r.length; c > a; a++) i = r[a], o += s.apply(null, [i].concat(t.call(e)));
        return o;
      }
      return "function" == typeof s ? s.apply(null, [r].concat(t.call(e))) : s;
    };
  }.call(this),
  function() {
    var t, e;
  ...
  function() {
    ...
    app.templates.aboutPage = function() {
      ...
      return '<div class="_toc">\n  <h3 class="_toc-title">Table of Contents</h3>\n  <ul class="_toc-list">\n    <li><a href="#credits">Credits</a>\n    <li><a href="#faq">FAQ</a>\n    <li><a href="#copyright">Copyright</a>\n    <li><a href="#plugins">Plugins</a>\n  </ul>\n</div>\n\n<h1 class="_lined-heading">API Documentation Browser</h1>\n<p>DevDocs combines multiple API documentations in a fast, organized, and searchable interface.\n<ul>\n  <li>Created and maintained by <a href="http://thibaut.me">Thibaut Courouble</a>\n  <li>Made at <a href="http://devdocs.io/s/shopify">Shopify</a> &mdash; one of the best software companies in the world\n  <li>Powered by <a href="http://devdocs.io/s/maxcdn" title="Content Delivery Network Services">MaxCDN</a> &mdash; content delivery that developers love\n  <li>Free and <a href="https://github.com/Thibaut/devdocs">open source</a>\n      <iframe class="_github-btn" src="http://ghbtns.com/github-btn.html?user=Thibaut&repo=devdocs&type=watch&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="100" height="20"></iframe>\n</ul>\n<p>To keep up-to-date with the latest development and community news:\n<ul>\n  <li>Subscribe to the <a href="http://eepurl.com/HnLUz">newsletter</a>\n  <li>Follow <a href="https://twitter.com/DevDocs">@DevDocs</a> on Twitter\n  <li>Join the <a href="https://groups.google.com/d/forum/devdocs">mailing list</a>\n</ul>\n<p class="_note _note-green">If you like DevDocs, please consider funding the project on\n  <a href="https://gratipay.com/Thibaut/">Gratipay</a>. Thanks!<br>\n\n<h2 class="_lined-heading" id="credits">Credits</h2>\n\n<p><strong>Special thanks to:</strong>\n<ul>\n  <li><a href="http://get.gaug.es/?utm_source=devdocs&utm_medium=referral&utm_campaign=sponsorships" title="Real Time Web Analytics">Gauges</a> for offering a free account to DevDocs\n  <li><a href="https://www.heroku.com">Heroku</a> and <a href="http://newrelic.com">New Relic</a> for providing awesome free service\n  <li>Daniel Bruce for the <a href="http://www.entypo.com">Entypo</a> pictograms\n  <li><a href="http://www.jeremykratz.com/">Jeremy Kratz</a> for the C/C++ logo\n</ul>\n\n<table class="_credits">\n  <tr>\n    <th>Documentation\n    <th>Copyright\n    <th>License\n  ' + function() {
        var n, o, s;
        for (s = [], n = 0, o = t.length; o > n; n++) e = t[n], s.push("<tr><td>" + e[0] + "<td>&copy; " + e[1] + '<td><a href="' + e[3] + '">' + e[2] + "</a>");
        return s;
  ...
  function() {
    ...
    app.templates.newsPage = function() {
        ...
        var n, o, s, i, r, a;
        for (i = new Date().getUTCFullYear(), o = "", r = 0, a = t.length; a > r; r++) s = t[r],
          n = new Date(s[0]), i !== n.getUTCFullYear() && (i = n.getUTCFullYear(), o += "<h4>" + i + "</h4>"),
          o += e(n, s.slice(1));
        return o;
      ...
      e = function(e, n) {
        ...
        for (e = '<span class="_news-date">' + t[e.getUTCMonth()] + " " + e.getUTCDate() + "</span>",
          s = "", o = a = 0, c = n.length; c > a; o = ++a) i = n[o], i = i.split("\n"), r = '<span class="_news-title">' + i.shift() + "</span>",
          s += '<div class="_news-row">' + (0 === o ? e : "") + " " + r + " " + i.join("<br>") + "</div>";
        return s;
      }, app.news = [
